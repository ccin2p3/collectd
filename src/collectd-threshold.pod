...
By default each C<Plugin>, C<Instance> or C<Type> string comparison is made with C<strcmp()>.
If C<UseRegex> is set to C<True> (this is not the default behaviour), Posix regexp will be used.
